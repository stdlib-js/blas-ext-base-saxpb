...
var saxpb = tryRequire( resolve( __dirname, './../lib/saxpb.native.js' ) );
var opts = {
...
tape( 'the function has an arity of 5', opts, function test( t ) {
	t.strictEqual( saxpb.length, 5, 'has expected arity' );
	t.end();
});
...
tape( 'the function returns a reference to the input array', opts, function test( t ) {
	...
	out = saxpb( x.length, 5.0, 3.0, x, 1 );
